    ...
    <div class="pusher">
      <div class="main-content">
        <div class="ui grid stackable padded">
          <div class="column">
          	<form:form action="${pageContext.servletContext.contextPath}/admin/ca/them.htm" modelAttribute="ca" enctype="multipart/form-data">
            <table class="ui celled padded table">            
			  ...
			  <tbody>			  
			    <tr>
			      ...
			      <div class="ui input">
  					<form:input path="maCa" style="max-width: 40px"/>
					</div><form:errors path = "maCa"/> 	       
			      </td>
			      <td>
			      ...
			      <div class="ui input" style="max-width: 80px" >
					<form:input path="soLuongDaBan" type ="number" min= "0"/></div><form:errors path = "soLuongDaBan"/> 
			      	...
			      	<button class="ui green inverted button" > Thêm</button>
			      <td>
			      </td>
			      </tr>
			  </tbody>
