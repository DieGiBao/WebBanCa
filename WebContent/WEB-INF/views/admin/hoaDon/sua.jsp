    ...
    <div class="pusher">
      <div class="main-content">
        <div class="ui grid stackable padded">
          <div class="column">
          	<form:form action="${pageContext.servletContext.contextPath}/admin/hoaDon/sua.htm" modelAttribute="hoaDon">
            <table class="ui celled padded table">            
			  ...
			  <tbody>			  
			    <tr>
			      ...
			      <div class="ui input">
  					<form:input path="maHoaDon" readonly="true" style="max-width: 40px"/>
					</div>		       
			      </td>
			      <td>
			      <div >
  					<form:input path="ngayBan" type="date"  style="max-width: 150px"/> <form:errors path = "ngayBan"/>
					</div>				      
			      </td>
			      <td>
			      <div class="ui input" style="max-width: 100px">
					<form:input path="user.email" /></div> <form:errors path = "user.email"/>
			      </td>
			      <td>
			      <div class="ui input" style="max-width: 100px">
					<form:input path="tongTien" type ="number" min ="0"  max ="100000000"/></div> <form:errors path = "tongTien"/>
			      </td>
