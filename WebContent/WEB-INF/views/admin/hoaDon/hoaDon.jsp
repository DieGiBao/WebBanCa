          ...
          <div class="column">
			...
			<c:forEach var="p" items="${hoaDon}">
			    <tr>
			      ...
			      <td>
			      <a href="admin/hoaDon/sua/${p.maHoaDon}.htm"><Button class="ui blue inverted button" > Sửa</Button></a>
			      <a href="admin/hoaDon/xoa/${p.maHoaDon}.htm"><Button class="ui red inverted button"  > Xóa</Button></a>	      
			      </td>
			      </tr>
			    </c:forEach>
			  </tbody>
			...
			<a href="admin/hoaDon/them.htm"><Button class="ui green inverted button"  > Thêm</Button></a>
          </div>
        </div>
      </div>
    </div>
