    ...
    <div class="pusher">
      <div class="main-content">
        <div class="ui grid stackable padded">
          <div class="column">
          	<form:form action="${pageContext.servletContext.contextPath}/admin/hoaDon/them.htm" modelAttribute="hoaDon">
            <table class="ui celled padded table">            
			  ...
			  <tbody>			  
			    <tr>
			      ...
			      <td>
			      <div class="ui input" style="max-width: 100px">
					<form:input path="tongTien"/></div> <form:errors path = "tongTien"/>
			      </td>
