    ...
    <div class="pusher">
      <div class="main-content">
        <div class="ui grid stackable padded">
          <div class="column">
          	<form:form action="${pageContext.servletContext.contextPath}/admin/user/sua.htm" modelAttribute="user">
            <table class="ui celled padded table">            
			  ...
			  <tbody>			  
			    <tr>
			      ...
			      <div class="ui input">
  					<form:input path="email" style="max-width:auto " readonly="true" />
					</div>		       
			      </td>
			      <td>
