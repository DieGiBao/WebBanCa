    ...
    <div class="pusher">
      <div class="main-content">
        <div class="ui grid stackable padded">
          <div class="column">
          	<form:form action="${pageContext.servletContext.contextPath}/admin/chiTietHoaDon/sua.htm" modelAttribute="chiTietHoaDon">
            <table class="ui celled padded table">            
			  ...
			  <tbody>			  
			    <tr>
			      ...
			      <td class="single line">
			      <div class="ui input">
  					<form:input path="hoaDon.maHoaDon"  readonly="true" style="max-width: 100px"/>
					</div><br><form:errors path = "hoaDon.maHoaDon"/>       
			      </td>
			      <td>
			      <div class="ui input">
  					<form:input path="ca.maCa"  readonly="true" style="max-width: 100px"/>
					</div><br><form:errors path = "ca.maCa"/>   
			      </td>
			      <td>
			      <div class="ui input">
  					<form:input path="soLuong" style="max-width: 100px"/>
					</div><br><form:errors path = "soLuong"/>   
			      </td>
			      <td>
			      <div class="ui input">
  					<form:input path="donGia" style="max-width: 100px"/>
					</div><br><form:errors path = "donGia"/>   
			      </td>
			      <td>
			      <div class="ui input">
  					<form:input path="thanhTien" style="max-width: 100px"/>
					</div><br><form:errors path = "thanhTien"/>   
			      </td>
			      	<button class="ui green inverted button" > Sửa</button>
			      <td>
			      </td>
			      </tr>
			  <tfoot>		        
