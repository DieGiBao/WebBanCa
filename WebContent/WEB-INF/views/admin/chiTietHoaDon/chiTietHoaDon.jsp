          ...
          <div class="column">
			...
			<c:forEach var="p" items="${chiTietHoaDon}">
			    <tr>
			      ...
			      <td>
			      <a href="admin/chiTietHoaDon/sua/${p.maChiTietHoaDon}.htm"><Button class="ui blue inverted button" > Sửa</Button></a>
			      <a href="admin/chiTietHoaDon/xoa/${p.maChiTietHoaDon}.htm"><Button class="ui red inverted button"  > Xóa</Button></a>
			      </td>
			      </tr>
			    </c:forEach>
			  </tbody>
			...
			<a href="admin/chiTietHoaDon/them.htm"><Button class="ui green inverted button"  > Thêm</Button></a>
          </div>
        </div>
      </div>
    </div>
